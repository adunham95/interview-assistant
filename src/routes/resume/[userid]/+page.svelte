<script lang="ts">
	...
	const skills = [
		...
		},
		{
			...
			items: ['Git', 'Docker', 'Kubernetes', 'AWS', 'CI/CD', 'Agile/Scrum']
		}
	];
	...
	<div class="container mx-auto px-4 max-w-5xl">
		<div class="bg-white shadow-lg rounded-lg overflow-hidden">
			...
			<div class="bg-green-500 text-white p-8">
				<div class="flex flex-col md:flex-row justify-between">
					<div>
						...
						<p class="text-xl mt-1">{personalInfo.title}</p>
					</div>
			...
			<div class="p-8">
				<!-- Experience -->
				<section class="mb-10">
					<h2 class="text-2xl font-bold text-gray-800 border-b-2 border-primary pb-2 mb-6">
						Professional Experience
					</h2>
					{#each experience as job}
						<div class="mb-8">
							<div class="flex flex-col md:flex-row justify-between mb-2">
								<h3 class="text-xl font-semibold text-gray-800">{job.position} | {job.company}</h3>
				...
				<section class="mb-10">
					...
					{#each education as edu}
						<div class="mb-6">
							...
							<div class="text-gray-700 mb-2">{edu.institution}</div>
				...
				<section class="mb-10">
					...
					<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
						{#each skills as skillGroup}
							<div>
								<h3 class="text-lg font-semibold text-gray-800 mb-2">{skillGroup.category}</h3>
