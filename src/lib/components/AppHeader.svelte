...
<header class="bg-surface shadow">
	<div class="mx-auto max-w-3xl px-2 sm:px-4 lg:max-w-full lg:divide-y lg:divide-content-3 lg:px-8">
            ...
            -->
					...
					>
						<div class="ml-4 min-w-0 flex-1">
							<div class="truncate text-base font-medium text-gray-800">{firstName} {lastName}</div>
